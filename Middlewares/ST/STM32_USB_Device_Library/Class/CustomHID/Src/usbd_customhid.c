...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgFSDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  /* 41 */
	...
	0x09, //desc size
	USB_DESC_TYPE_INTERFACE, //desc type
	0x01, //number of interface
	0x00, //alternative setting
	0x01, //endpoint count
	0x03, //hid interface class
	0x01, // 1 - boot, 0 - no boot
	0x01, // 1 - standart keyboard protocol for boot
	0x00, // index of string descriptor
	
	//HID Descriptor Keyboard
	0x09, //size
	CUSTOM_HID_DESCRIPTOR_TYPE, //custom hid descriptor
	0x11, 0x01, //version hid
	0x00, //language code
	0x01, //report descriptor count 
	CUSTOM_HID_REPORT_DESC, //report descriptor type
	HID_KEYBOARD_REPORT_DESC_SIZE, //keyboard report size (determinate later)
	0x00, //optional reports
	
	//Endpoint descriptor
	0x07, //size
	USB_DESC_TYPE_ENDPOINT, //type - endpoint
	HID_EPIN_ADDR, //address (determinate later)
  0x03, //interrupt ep
	HID_EPIN_SIZE, //ep size (determinate later)
	0x00, 
	CUSTOM_HID_FS_BINTERVAL, //polling interval
	//66byte this descriptors
